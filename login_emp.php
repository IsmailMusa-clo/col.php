...
if (isset($_POST['submit'])) {
   ...
   $sql = "select * from teacher where name='$username' and password='$password'";
...
<head>
   ...
   <title>صفحة تسجيل دخول المهندس</title>
   <!-- Icons -->
   <link href="admin/assets/css/font-awesome.css" rel="stylesheet">
   <link href="admin/assets/css/simple-line-icons.css" rel="stylesheet">
   <!-- Main styles for this application -->
   <link href="admin/assets/css/dest/style.css" rel="stylesheet">
</head>
